...
final garageBootstrapRepositoryProvider = Provider<GarageBootstrapRepository>((
  ...
  return SupabaseGarageBootstrapRepository(ref.watch(supabaseClientProvider));
});
...
final garageBootstrapProvider = FutureProvider<GarageBootstrap>((ref) async {
  final userId = ref.watch(currentUserIdProvider);
  if (userId == null) {
    return GarageBootstrap.empty;
  }
  return ref.watch(garageBootstrapRepositoryProvider).load();
});
