  ...
  static ReminderProjection? project({
    ...
    if (rule.oneTime) {
      return _projectOneTime(
        ...
        // The rule's own issued date over the vehicle's baseline whenever it
        // is known: a one-time rule has no "last service" to measure from,
        // so a vignette or a premium fell back to the day the car was
        // added — often the better part of a year earlier — and read as
